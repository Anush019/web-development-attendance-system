...
<h1>CompOff Request Form</h1>
        ...
        <div class="overlay-container">
             <label for="Leave_From">Leave From:</label>
                ...
                <label for="Overtime_Date_Hours">Overtime Date - Hours:</label>
                <select id="Overtime_Date_Hours" name="Overtime_Date_Hours" required>
...
function showNotification() {
    alert("CompOff Request Submitted");
}
