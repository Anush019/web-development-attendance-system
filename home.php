...
// Query to retrieve user information and user type from users table
// $sql = "SELECT * FROM personal_info JOIN users ON personal_info.Employee_id = users.Employee_id WHERE personal_info.Employee_id = '$username'";
...
if (!$result) {
    ...
    $pfp = $row['pfp'];
     // Assuming 'User_type' is the column name
}
...
<div class="container" id="container">
  <div class="form-container sign-in-container">
    <form action="#">
    <?php $sql="SELECT pfp FROM personal_info " ?>
